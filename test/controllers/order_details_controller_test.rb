...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { Discount: @order_detail.Discount, OrderId: @order_detail.OrderId, ProductId: @order_detail.ProductId, Quantity: @order_detail.Quantity, UnitPrice: @order_detail.UnitPrice } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { Discount: @order_detail.Discount, OrderId: @order_detail.OrderId, ProductId: @order_detail.ProductId, Quantity: @order_detail.Quantity, UnitPrice: @order_detail.UnitPrice } }
